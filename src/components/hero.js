...
// Terima 'heroSlides' (sebuah array) dari data.js
export function renderHero(heroSlides) {

  // 1. Buat <li class="splide__slide"> secara dinamis
  const slidesHTML = heroSlides.map(slide => `
    <li class="splide__slide">
      ...
      <div class="relative h-screen flex items-center justify-center text-center text-white">
        ...
        <div class="relative z-20 p-4 max-w-3xl">
  ...
  `).join(''); // Menggabungkan semua HTML slide

  // 2. Kembalikan struktur lengkap Splide
  return `
